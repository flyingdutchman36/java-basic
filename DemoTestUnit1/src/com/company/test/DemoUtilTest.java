...
public class DemoUtilTest {
    ...
    @DataProvider
    public Object[][] data() {
        Object[][] obj = new Object[3][3]; // 2 case 3 parameters
        obj[0][0] = 1;
        obj[0][1] = 100;
        obj[0][2] = 75.0;
    ...
    public void testCircle() {
        assertEquals(DemoUtil.circle(10),314.1592, .001); // delta ค่าต่างกับความเป็นจริงที่รับได้
        assertTrue(5 > 3);
